...
def _lineas_entrega_pendiente(pedido) -> list[str]:
    ...
    if franja:
        lineas.append(
            ...
            "pedido y no prometas una hora exacta (ni le anuncies que la dueña la confirma)."
        )
    else:
        lineas.append(
