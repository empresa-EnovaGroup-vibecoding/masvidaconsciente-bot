...
**Pendientes:**
- ✅ **Auto-deploy HECHO Y PROBADO** (2026-07-10): push a master → GitHub Actions despliega bot+worker en AMBOS servidores (verificado, run "success"). Ver punto 5. Pendiente opcional: mismo flujo para el dashboard. (El env/config sigue SIN sincronizarse: el auto-deploy mueve solo CÓDIGO.)
