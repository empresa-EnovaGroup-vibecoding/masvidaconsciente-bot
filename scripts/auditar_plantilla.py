...
async def main():
    ...
    chk("P6", "CUMPLE" if en("efectivo") and en("20") and en("bcv") else "NO CUMPLE",
        "paso 6 · método de pago; Bs a BCV; dólares (efectivo/Zelle/Binance): cuenta con delivery y después 20%")
    ...
    try:
        ...
        chk("dinero.efectivo", "CUMPLE" if efectivo == Decimal("13.60") else "NO CUMPLE",
            "efectivo = 20% a la cuenta con delivery (($14+$3)×0,80 → $13.60)", f"devolvió {efectivo}")
    except Exception as e:
