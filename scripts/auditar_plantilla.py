...
async def main():
    ...
    chk("P6", "CUMPLE" if en("efectivo") and en("20") and en("bcv") else "NO CUMPLE",
        "paso 6 · método de pago; Bs a BCV + delivery; dólares (efectivo/Zelle/Binance) 20% sobre productos, delivery completo")
    ...
    try:
        ...
        chk("dinero.efectivo", "CUMPLE" if efectivo == Decimal("14.20") else "NO CUMPLE",
            "efectivo = 20% a los productos + delivery completo ($14+$3 → $14.20)", f"devolvió {efectivo}")
    except Exception as e:
