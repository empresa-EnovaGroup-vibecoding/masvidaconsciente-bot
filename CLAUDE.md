...
**Los 5 de referencia** (casi no cambian): `RESPALDO.md` · `BRIEF-personalidad-alejandra-2026-09-06.md` (la voz vigente) · `BRIEF-personalidad-whuilianny.md` (histórico) · `BRIEF-closer-masvida.md` · `PRP-cobro.md`.
